...
#include <WidgetRTC.h>
//////////////////////////////////////////////////////
BlynkTimer  con_manager, rtc_time_req_timer, upd_equipment_detail_timer, beep_timer;
BlynkTimer  scheduler_1_timer, scheduler_2_timer;
BlynkTimer arduino_serial_timer;
...
String arduino_serial_str, arduino_serial_char_first, arduino_serial_char_rest;
/////////////////////////////////////////////
int d1_state = LOW;
int d2_state = LOW;

long int k_watt_hr_value,k_watt_hr_value_reset_maximum=1;
/////////////////////////////////////////////
void setup() {
  ...
  arduino_serial_timer.setInterval(300, arduino_serial_reader_func);
...
void loop()
{
  ...
  scheduler_1_timer.run();  //device 1's hardware switch timer and schedule timer
  scheduler_2_timer.run();  //device 2's hardware switch timer and schedule timer
  
  arduino_serial_timer.run();
}
