...
////////////////////// alexa integration /////////////
#include "fauxmoESP.h"  // alexa library header
//////////////////////////////////////////////////////
...
fauxmoESP fauxmo; //declaring for alexa library member
...
void loop()
{
  ...
  if (BlynkState::is(MODE_RUNNING)) {
    alexaDevAdd(); // alexa part for device broadcast
    fauxmo.onMessage(callback); // used for alexa calls
    fauxmo.handle(); // alexa operation
  }
